...
//print_array($leaveapply);
$leaveapplyvalues = array();
$myleave = $controller->leavegenerate();
?>
            ...
            <form id="leaveconfigform" role="form" method="post" class="form-horizontal" novalidate>
                ...
                <div class="form-group">
                    ...
                    <div <?= hideorshow(array_keyvaluen($leaveapply, 'id_leavetype')['status']) ?>>
                        ...
                        <div class="col-sm-4">
                            <select  class="form-control search-select" placeholder="Select Form" name="id_leavetype" id="id_leavetype"  >
                                <option value="">-LEAVE TYPE-</option>
                                <?php
                                foreach ($controller->allselectablebytable('leaveconfig') as $employee) {
                                    ?>
                ...
                <div class="form-group">
                    <div <?= hideorshow(array_keyvaluen($leaveapply, 'leavebal')['status']) ?>>
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="LEAVE BALANCE" id="leavebal" name="leavebal"  class="form-control" value="<?= $myleave ?>" readonly>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#leaveconfigform')
            ...
            postformdatajax("#leaveconfigform", 'submit', '<?= base_url('staff/uploadapply') ?>', '#updatepersone');
