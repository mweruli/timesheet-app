...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.13.3/xlsx.core.min.js"></script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.13.3/xlsx.core.min.js"></script>
<style>

</style>
<div class="panel-body" id="client_onexx">
    <div id='datus' class="inner second"><font size="3" color="green">Test The Status Of This Apparatus</font></div>
    <div class="row">
        <br>
        ...
        <div class="col-md-12 space20">
            ...
            <div class="btn-group pull-right" style="margin-top: -10px;">
                ...
                <ul class="dropdown-menu dropdown-light pull-right">
                    <li>
                        <!--<a href="#" id="exportpdf" onclick="printJS({printable: 'jajamma', type: 'html', header: 'General Report Clients', maxWidth: '1000', honorMarginPadding: false, targetStyles: ['*']})">-->
                        <a href="#" id="papapa">
                            Save as PDF
                        </a>
                    </li>
                    <!--                    <li>
                                            <a href="#" onclick="export_damclinetxx()">
                                                Export to Excel
                                            </a>
                                        </li>-->
                </ul>
...
//            "scrollX": true
//        });
        var tabletwor = $('#tatamamaidxx').DataTable({
            scrollX: true,
            dom: 'Bfrtip',
            buttons: [
                //                'copyHtml5',
